...
const TABS: { value: TabValue; label: string }[] = [
  ...
  { value: "selection", label: "About Selection" },
...
export default function RequestFeedbackView() {
  ...
  const save = useCallback(() => {
    ...
    if (form.toPerson.length === 0) missing.push("To Person");
    ...
    const payload: SaveRequestFeedbackPayload = {
      fromPerson: form.fromPerson,
      toPerson: toPersonStr,
      toPersonEmail: form.toPersonEmail,
      ...
      <div className={styles.root}>
        <div className={styles.titleSection}>
          ...
          <div className={styles.titles}>
            <span className={styles.titleText}>Request Feedback With Selection</span>
  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.titleSection}>
        ...
        <div className={styles.titles}>
          <span className={styles.titleText}>Request Feedback With Selection</span>
          <span className={styles.subtitleText}>Request feedback based on the current selection.</span>
        </div>
      </div>
      ...
      <div className={styles.commandBar}>
        ...
        {/* View List of Feedback — must be opened from ribbon */}
        <button
        ...
        {/* View List of Analysis — must be opened from ribbon */}
        <button
          className={`${styles.cmdIconBtn} sl-icon-btn`}
      ...
      {/* ── Selection label banner (About Selection tab only) ─────────────── */}
      {activeTab === "selection" && (
        <div style={{
          height: "37px",
          background: "#F5F5F5",
          ...
          <span style={{
            ...
            The Actual Selection The Feedback is Requested With
          </span>
        </div>
      )}
      ...
      <div
        ...
        style={activeTab === "files" || activeTab === "selection" ? { padding: 0 } : undefined}
      >
        ...
        {activeTab === "feedback" && (
          <>
            ...
            {/* Person Address */}
            <div style={rowStyle}>
              <span style={labelStyle}>Person Address</span>
              <input
                style={inputStyle}
                type="email"
            ...
            <div style={rowTopStyle}>
              ...
              <div style={{ flex: 1 }}>
                <RichEditor
                  ...
                  placeholder="Enter the feedback request..."
                />
              </div>
            </div>
          </>
        ...
        {/* ── About Selection tab ─────────────────────────────────────────── */}
        {activeTab === "selection" && (
          <div style={{ padding: "20px", fontSize: "26.3px", fontWeight: "400", color: "#1B1B1B", lineHeight: "39px", wordBreak: "break-word" }}>
            {initData.selection || <span style={{ color: "#999", fontSize: "14px", lineHeight: "1.5" }}>No text selected.</span>}
          </div>
        )}
