  ...
  return ReactDOM.createPortal(
    <>
      ...
      >
        ...
        <div
          style={{
            height: 57, flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "space-between",
            padding: "0 20px", borderTop: `1px solid ${C.grey88}`, background: C.white, boxSizing: "border-box",
          }}
        >
          <span style={{ fontSize: 10.1, color: C.grey38, fontFamily: "inherit" }}>
            Interpret the identified principle and submit.
          </span>
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            <button
              ...
              style={{
                width: 74, height: 32, background: cancelHover ? "#F3F3F3" : C.white,
                border: `1px solid ${C.grey78}`, borderRadius: 4, fontSize: 12.4,
                fontFamily: "inherit", cursor: "pointer", color: C.grey11,
              }}
            >
              Cancel
            </button>
            <button
              ...
              onMouseLeave={() => setSubmitHover(false)}
              style={{
                width: 137, height: 32, background: submitHover ? C.blueHover : C.blue,
                border: "none", borderRadius: 4, fontSize: 12.6, fontWeight: 700,
                fontFamily: "inherit", cursor: "pointer", color: C.white, whiteSpace: "nowrap",
              }}
            >
              Interpret Principle
            </button>
